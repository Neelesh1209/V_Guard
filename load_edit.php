...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    $sql = "SELECT * FROM load1 WHERE id=$id";
    ...
    do {
        ...
        $sql = "UPDATE load1 SET LOCATION = '$LOCATION', Distance_in_KM = '$Distance_in_KM', No_of_Time = '$No_of_Time', Total_Distance = '$Total_Distance' WHERE id = $id";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn" href="load.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>    
