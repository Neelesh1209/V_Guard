...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    ...
    do {
        if ( empty($POWER_SAVING_UNITS_in_KW) || empty($Conversion_Factor) || empty($CO2_Emission_in_Kg) ) {
        ...
        $sql = "INSERT INTO saving (POWER_SAVING_UNITS_in_KW, Conversion_Factor, CO2_Emission_in_Kg) " .
               "VALUES ('$POWER_SAVING_UNITS_in_KW', '$Conversion_Factor', '$CO2_Emission_in_Kg')";
