...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    $SOLAR_PV_UNITS_in_KW = $row["SOLAR_PV_UNITS_in_KW"];
    ...
    do {
        if ( empty($id) || empty($SOLAR_PV_UNITS_in_KW) || empty($Conversion_Factor) || empty($CO2_Emission_in_Kg) ) {
            $errorMessage = "All the fields are required";
            break;
        }

        $sql = "UPDATE solar SET SOLAR_PV_UNITS_in_KW = '$SOLAR_PV_UNITS_in_KW', Conversion_Factor = '$Conversion_Factor', CO2_Emission_in_Kg = '$CO2_Emission_in_Kg' WHERE id = $id";
