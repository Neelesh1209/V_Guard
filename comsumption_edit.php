...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    $sql = "SELECT * FROM diesel_comsumption WHERE id=$id";
    ...
    do {
        ...
        $sql = "UPDATE diesel_comsumption SET DG_UNITS_in_KW = '$DG_UNITS_in_KW', TOTAL_DIESEL_CONSUMPTION = '$TOTAL_DIESEL_CONSUMPTION', Conversion_Factor = '$Conversion_Factor', CO2_Emission_in_Kg = '$CO2_Emission_in_Kg' WHERE id = $id";
