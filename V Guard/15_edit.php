...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    $sql = "SELECT * FROM emission_15 WHERE id=$id";
    ...
    do {
        ...
        $sql = "UPDATE emission_15 SET DG_UNITS_in_KW = '$DG_UNITS_in_KW', TOTAL_DIESEL_CONSUMPTION = '$TOTAL_DIESEL_CONSUMPTION', Conversion_Factor = '$Conversion_Factor', CO2_Emission_in_Kg = '$CO2_Emission_in_Kg' WHERE id = $id";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn" href="15.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>    
