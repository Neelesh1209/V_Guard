...
<body>
    <div class="container my-5">
        <h2 class="heading">Loading per Month</h2><br>
        <a class="btn btn-primary" href="create_load.php" role="button">New Entry</a>
        <div class="back">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <td>
                        <a class='btn1' href='load_edit.php?id=$row[id]'>Edit</a>
                        <a class='btn2' href='load_delete.php?id=$row[id]'>Delete</a>
                    </td>
                    <tr>    
                    ";
                }
