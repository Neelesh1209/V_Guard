...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    do {
        ...
        $sql = "UPDATE bike SET LOCATION = '$LOCATION', Distance_in_KM = '$Distance_in_KM', No_of_Time = '$No_of_Time', Total_Distance = '$Total_Distance' WHERE id = $id";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn" href="bike.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>    
